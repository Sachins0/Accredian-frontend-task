...
const Footer = () => {
  return (
    ...
    <div className="max-w-6xl mx-auto border-t border-gray-700 my-4"></div>
    ...
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm text-gray-300">
          ...
          <li>Data Science Admission Helpline:+91 9079632374 (9 AM - 7 PM)</li>
          <li>Product Management Admission Helpline:+91 9823811095</li>
        ...
        <h3 className="font-medium mt-6 mb-2">Why Accredian</h3>
      ...
      <div>
        <h3 className="font-medium mb-4">Accredian</h3>
        <ul className="space-y-2">
          {[
            'About',
            'Career',
    ...
    <div className="max-w-6xl mx-auto mt-8 pt-4 border-t border-gray-700 text-center text-xs text-gray-400">
